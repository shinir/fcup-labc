...
PPMIMAGE* grayscale(PPMIMAGE *imgA) {
  ...
  for(int i=0; i<imgA->height; i++) {
    for(int j=0; j<imgA->width; j++) {
      imgB->mat[i][j].R = round(0.2126*imgA->mat[i][j].R + 0.7152*imgA->mat[i][j].G + 0.0722*imgA->mat[i][j].B);
      imgB->mat[i][j].G = round(0.2126*imgA->mat[i][j].R + 0.7152*imgA->mat[i][j].G + 0.0722*imgA->mat[i][j].B);
      imgB->mat[i][j].B = round(0.2126*imgA->mat[i][j].R + 0.7152*imgA->mat[i][j].G + 0.0722*imgA->mat[i][j].B);
    }
  }
  return imgB;
}
